...
RUN git clone https://github.com/kijai/ComfyUI-HunyuanVideoWrapper.git custom_nodes/ComfyUI-HunyuanVideoWrapper && \
    ...
    git clone https://github.com/styler00dollar/VSGAN-tensorrt-docker/releases/download/models/rife49.pth custom_nodes/ComfyUI-Frame-Interpolation/ckpts/rife/rife49.pth
